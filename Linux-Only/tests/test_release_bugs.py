...
class PathValidationTests(unittest.TestCase):
    ...
    def test_windows_path_rejected_on_non_windows(self):
        ...
        self.assertIn("Windows ComfyUI path", msg)
        self.assertTrue(
            "/home/you/ComfyUI" in msg or "Linux path" in msg or "Windows PC" in msg
        )
        ...
        self.assertTrue(
            ...
            or "Linux path" in detail
            or "/home/you/ComfyUI" in detail
